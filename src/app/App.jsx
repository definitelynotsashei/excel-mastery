          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-300">
                The repository now includes the first real content model for the
                formulas track: tier metadata, challenge definitions, and
                progression helpers aligned to the vertical-slice plan.
              </p>
            </div>
            <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/10 px-5 py-4 text-sm text-cyan-100">
              ...
              <div className="mt-1">Milestone 1: challenge model and curriculum data</div>
            </div>
          </div>
        </header>
